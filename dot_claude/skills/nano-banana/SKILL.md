...
**Always use the pro model** (`gemini-3-pro-image-preview`) for high-quality outputs such as:
- Wallpapers and desktop backgrounds
- Print-ready artwork or posters
- Large-format images (4K+)
- Any request where the user emphasizes quality or detail
